...
Add the sample CSV file in this repo location `integration-samples/integrator/samples/shipment-processor/data/<sample-csv>` to the following directory in the SFTP server: 
`/csv/prod`
